...
|--------------------------------------------------------------------------
*/
$config['website_name'] 		= 'http://www.eidaramata.com';
$config['app_name'] 			= 'EMDP System';
$config['endorsed_by'] 			= 'Endorsed by PT Eidara Matadata Presisi';
$config['group_name'] 			= 'PT EII';
$config['website_name_full'] 	= 'http://'.$_SERVER['HTTP_HOST']."/";;
$config['company_name'] 		= 'PT EIDARA MATADATA PRESISI';
$config['webmaster_email'] 		= 'noreply@eidaramata.co.id';
$config['webreply_email'] 		= 'asep.jamaludin@encona.co.id';
$config['webcc_email'] 			= 'justin.the@encona.co.id';
$config['nickname'] 			= 'EMDP System';
$config['company_address'] 		= '18 Office Park Building 12th Floor, Jalan T.B. Simatupang Kav 18, Pasar Minggu, RT.2/RW.1, Kebagusan, Jakarta Selatan, Kota Jakarta Selatan, DKI Jakarta 12520, Indonesia';
$config['phone'] 				= '+62 21 22783300';
$config['teamit'] 				= 'Team IT PT EIDARA MATADATA PRESISI';
...
|--------------------------------------------------------------------------
*/
$config['autologin_cookie_name'] = FALSE;//'autologin';
...
$config['recaptcha_public_key'] 	= '6LfPsyIUAAAAAHSF7ysku08airh3BAF_xfjXrGtt';
$config['recaptcha_private_key'] 	= '6LfPsyIUAAAAALS9o4DpHi2twRqDHKNFftaZ2XXW';
