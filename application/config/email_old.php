...
$config['smtp_host']        = 'mail.eidaramata.com';//'mail.encona.co.id';
$config['smtp_user']        = 'noreply-eidaramata.com';//'noreply.system@encona.co.id';
$config['smtp_pass']        = '12064899';//'h45t4l4v15t4_b4b1';
