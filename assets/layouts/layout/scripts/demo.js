...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        $('.toglr', panel).click(function() {
            $('.toglr').hide();
            $('.toglrclose').show();
            $('.theme-panel > .thmopt').show();
        });

        $('.toglrclose', panel).click(function() {
            $('.toglr').show();
            $('.toglrclose').hide();
            $('.theme-panel > .thmopt').hide();
        });
		
		$('.mnu_hide', panel).click(function() {
            $('.mnu_hide').hide();
            $('.mnu_toggler').show();            
			$('.theme-panel > .thmeopt').show();
        });

        $('.mnu_toggler', panel).click(function() {
            $('.mnu_hide').show();
            $('.mnu_toggler').hide();
			$('.theme-panel > .thmeopt').hide();            
        });
